			...
			div(cls("container"),
			  div(cls("row align-items-center v-h-full"),
				div(cls("col-lg-10 col-xxl-6"),
				  h1(cls("heading-2 text-white mb-5 aos-init aos-animate"), attrDataAos("fade-up"), "We are a creative agency by Untree.co"),
				  p(cls("d-flex aos-init aos-animate"), attrDataAos("fade-up"), attrDataAosDelay("200"),
