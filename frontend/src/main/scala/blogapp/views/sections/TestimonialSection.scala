    ...
    div(
      ...
      div(
        ...
        div(
          cls("row mb-5"),
          div(
            cls("col-md-6 aos-init aos-animate"),
            attrDataAos("fade-up"),
            span(cls("subheading mb-2 d-inline-block"), "Testimonials"),
            h2("What's Our Client Think...")
          )
        ),
        div(
          cls("testimonal-wrap aos-init aos-animate"),
          attrDataAos("fade-up"),
          ...
          div(
            ...
            div(
              ...
              div(
                cls("testimonial"),
                span(cls("quote"), "&rdquo;"),
                blockQuote(
                  p(
                    "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eum consequuntur, iure quidem officiis adipisci, error odit omnis consequatur doloremque nobis. Quam vitae omnis perferendis excepturi?"
                  )
                ),
                div(
                  cls("d-flex author align-items-center"),
                  div(cls("pic"), img(cls("img-fluid"), src("medio/images/person_1.jpg"))),
                  div(cls("author-name"), h2("Jon Smith"), span("CEO, Co-Founder XYZ Inc."))
                )
              )
            ),
            div(
              ...
              div(
                ...
                div(
                  cls("d-flex author align-items-center"),
                  div(cls("pic"), img(cls("img-fluid"), src("medio/images/person_2.jpg"))),
                  div(cls("author-name"), h2("Jake Mackey"), span("COO, Co-Founder XYZ Inc."))
                )
              )
            )
          )
