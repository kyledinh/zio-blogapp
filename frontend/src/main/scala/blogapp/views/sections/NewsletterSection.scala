...
final case class NewsletterSection() extends Component {
  ...
  val body: Div =
    div(
      cls("section section-contact m-md-5 px-md-5"),
      div(
        cls("container"),
        ...
        form(
          ...
          div(
            ...
            div(
              ...
              div(cls("form-group"), input(cls("form-control"), typ("text"), placeholder("Your name")))
            ),
            div(
              cls("col-sm-4 col-md-4 col-lg-4"),
              div(cls("form-group"), input(cls("form-control"), typ("email"), placeholder("Your email")))
            ),
            div(
              cls("col-sm-4 col-md-4 col-lg-4"),
              div(cls("form-group"), input(cls("btn btn-black btn-block"), typ("submit"), placeholder("Subscribe")))
            )
          )
        )
      )
